...
namespace DGVPrinterHelper //AllocationRequest
{
    ...
    public class DGVPrinter
    {
        ...
        public string AdditionalTitle { get; internal set; }
        public Color AdditionalTitleColor { get; internal set; }
        ...
        public DGVPrinter()
        {
            ...
            subtitlefont = new Font("Segoe UI", 12, FontStyle.Bold, GraphicsUnit.Point);
